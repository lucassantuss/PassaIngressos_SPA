...
import styles from "./InfoVendaIngresso.module.css";

export default function InfoVendaIngresso() {
  return (
    <div className={styles.infoVendaIngressoContainer}>
      <CampoTitulo titulo="Passo a passo - Venda de Ingressos" />

      <div className={styles.cardGridInfoVendaIngresso}>
        <InfoCard
          icon="person-circle"
