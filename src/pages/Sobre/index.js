        ...
        <div className={styles.aboutContainer}>
            ...
            <div className={styles.imageAboutContainer}>
                <div className={styles.imageAboutRow}>
                    <img src='/images/groupMembers/danilo.jpg' alt="Danilo Rodrigues Dantas" />
                    <img src='/images/groupMembers/renan.jpg' alt="Renan Cesar de Araujo" />
                </div>
                <div className={styles.imageAboutRow}>
                    <img src='/images/groupMembers/lucas.jpg' alt="Lucas Araujo dos Santos" />
                </div>
            </div>
        </div>
    );
